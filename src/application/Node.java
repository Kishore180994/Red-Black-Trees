...
public class Node {
	...
	private boolean left_child_of_parent; //an indicator this node is the left child of its parent
										  //true - left
	  									  //false - right
	
	/*******************************	Implementation Here:  *****************************************/
	//Feel free to add any additional data member here and the corresponding "setter" and "getter"
	//It is really not necessary to create any  additional function members here other than "setter" and "getter"
	//One suggestion is put a "color" data member, which indicates "black" or "red" color
